...
contract('Exchange', function (accounts) {
  ...
  it("test buy after sell orders", async function () {
    ...
    // позволять выставлять оредра на продажу
    ...
    //без хэшей нельзя выставять заявки на покупку
    await expectThrow(
      ex.buy(bc.eth_kovan, web3.toWei(1, 'finney'), web3.toWei(0.6), {from: role.trader3})
    ); // no hashes
    //позволять добавлять хэши. чтобы был запас хэшей
